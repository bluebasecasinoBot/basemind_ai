...
__sS([
    {
        ...
        style:{
            ...
            overflowX:"hidden",
            overflowY:"scroll",
            background:"linear-gradient(135deg, #0D1117, #1A1A2E, #2C2F40)",
...
__SYD.launch_app_btn = () =>{
    return __c(
        ...
        ],
        {
            events:{
                onclick:e =>{
                    location.href = "baseMind_creation/creation.html"
                }
            }
        }
    )
        ...
        ],
        {
            events:{
                onclick: e =>{
                    ...
                    __p(["popUp" , "displayText"])("Access your BaseMind AI AI 😃");
                }
            }
        }
    )
...
__SYD.verify_agent = () =>{
    return __c(
        "div",
        {
            style:`padding:15px 25px;text-transform:none;border-radius:15px;${__p(["fetchAgent" , "verifyingAgent"],false) ? "pointer-events:none;opacity:.4;" : ""}`,
            class:"launch_btn"
        },
        [
            __c(
