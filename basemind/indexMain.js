...
__SYD.container = () =>{
    return __c(
        "div",
        {
            style:__sC['container']() + "background-size:cover;background-position:center top;background-repeat: no-repeat;"
        },
        [
            __SYD.subContainer(),
            __SYD.MainCanvas(),
    ...
    return __c(
        ...
        [
            ...
            __c(
                ...
                [
                    __c("span" , {style:"color:#3399FF;text-shadow:2px 2px 1px #141414 , 0 0 1px #000 , 0 0 6px #3399FF;"},["BaseMind AI "])
                ]
            ),
        ],
        {
...
__SYD.subContainer = () =>{
    ...
    return __c(
        "div",
        {
            style:`min-height:200%;width:100%;height:fit-content;position:relative;display:flex;padding-top:0px;flex-direction:column;row-gap:3rem;align-items:center;color:ffc2cb;z-index:200;background:url(./assets/logoIcon.png);background-position:top center;background-attachment:fixed;`,
            class:"subContainer"
        },
        [
            __SYD.scaleNav(),
