...
__SYD.userAgentAi__sections_main = () =>{
    return __c(
        ...
        [
            ...
            //     "h2",
            //     {
            //         style:"font-size:20px;color:#3399FF;font-weight:500;text-transform:capitalize;margin-bottom:16px;position:absolute;left:50%;transform:translateX(-50%);top:5px;color:#fff;font-family:shine;text-shadow:2px 2px 1px #141414;text-align:center;"
            //     },
            //     [
            //         `${__p(["userAgentAi__sections_main" , "topText"] , "Customize Your AgentB AI Assistant")}`
            //     ]
            // ),
...
__SYD.fetchAgent = () =>{
    return __c(
        "div",
        {
            style:`height:fit-content;min-height:fit-content;max-width:600px;width:90%;border-radius:20px;display:${__p(["userAgentAi__sections_main" , "section1"] , false) ? "flex" : "none"};justify-content:center;align-items:center;row-gap:30px;padding:30px 30px;flex-direction:column;background:#0D1117;`
        },
        [
            __c(
                "h1",
                ...
                [
                    'Access - Edit ' , __c("span" , {style:"color:#3399FF;text-shadow:2px 2px 1px #141414 , 0 0 1px #000 , 0 0 6px #3399FF;"},["BASEMIND "]) , "AI Assistant"
                ]
            ),
            __c(
                "p",
...
__SYD.infoSection___accessAgent = ({text = "" , ph = ""} = {}) =>{
    return __c(
        "div",
        {
            style:"padding:20px 16px;background:#2C2F40;display:flex;flex-direction:column;row-gap:10px;border-radius:15px;width:100%;"
        },
        [
            __c(
                "h2",
            ...
            __SYD.input_type_text({name:"agentname__id" , type:"text" , ph:ph , w:"500" , size:"16px" , inject:"background:#0D1117;box-shadow:unset;font-family:monospace;height:60px;border:none;border-radius:inherit;" , cls:"launch_btn" , fnc:{oninput:e =>{
    ...
    return __c(
        ...
        [
            __c(
                ...
                [
                    __SYD.ul_lists_el({child:__SYD.pTag({text:"Use Agent" , class_:"navClick" , style:`display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "none" : "auto"};font-size:16px;font-weight:700;background:linear-gradient(to top right , #8A2BE2 , #00FFFF);pointer-events:auto;${!__p(["userAgentAi__sections_main" , "agentVerification"],false) ? "pointer-events:none;opacity:.4;" : ""}`}) , function_:{
                        onclick:() =>{
