...
__SYD.agent_use_chat_main = () =>{
    return __c(
        "div",
        {
            style:`height:100%;width:100%;background:#2C2F40;display:${__p(["userAgentAi__sections_main" , "section2"] , false) ? "flex" : "none"};justify-content:center;align-items:center;min-height:100vh;`
        },
        [
            __c(
                "h2",
                {
                    style:"font-size:20px;color:#3399FF;font-weight:500;text-transform:capitalize;margin-bottom:16px;position:absolute;left:50%;transform:translateX(-50%);top:20px;color:#fff;font-family:shine;text-shadow:2px 2px 1px #141414;text-align:center;width:100%;pointer-events:none;opacity:.7;"
                },
                [
                    "Agent ~" , __c("span" , {style:"color:#3399FF;text-shadow:2px 2px 1px #141414 , 0 0 1px #000 , 0 0 6px #3399FF;"},[` ${__p(["userAgentAi__sections_main" , "agentLoginInfo" , "agentName"] , "Agent name")} 🤖 `.toUpperCase()]), __c("span" , {style:"color:#3399FF;text-shadow:2px 2px 1px #141414 , 0 0 1px #000 , 0 0 6px #3399FF;"},["... "])
                ]
            ),
            __c(
                "div",
...
__SYD.chatArea__agent = () =>{
    ...
    return __c(
        "div",
        {
            style:"height:100%;width:100%;background:#0D1117;border-radius:15px;padding:10px;padding-top:40px;display:flex;flex-direction:column;overflow:scroll;"
        },
        [
            ...get_render_chat(),
            __c(
...
__SYD.messageTab = () =>{
    return __c(
        "div",
        {
            style:"height:140px;width:100%;background:inherit;min-height:140px;display:flex;gap:10px;border-radius:15px;position:relative;"
        },
        [
            __SYD.userTextCount(),
            __SYD.textArea_type_text({name:"agentname__id" , type:"text" , ph:"Enter your message" , w:"500" , size:"16px" , inject:"background:#0D1117;box-shadow:unset;font-family:monospace;height:80px;border:none;border-radius:inherit;width:100%;resize:none;padding:16px;" , cls:"launch_btn" , fnc:{oninput:e =>{
            ...
            __c("i" , {style:`border-radius:inherit;font-size:25px;text-align:center;color:#fff;font-weight:900;height:50px;min-width:50px;background:#0066FF;display:flex;align-items:center;justify-content:center;${__p(["agent_use_chat_main" , "startAutoType"] , false) ? "opacity:.6;pointer-events:none;" : ""}` , class:`${"fa-brands fa-stack-exchange"} click`},[],{
                events:{
                    onclick:async e =>{
                        if(!__p(["agent_use_chat_main" , "startAutoType"] , false))
                        {
    ...
    return __c(
        ...
        [
            __c(
                "i",
                {
                    style:"height:20px;width:20px;font-size:20px;min-width:20px;color:#0066FF;",
            ...
            __c(
                "div",
                {
                    style:"padding:15px 10px;min-height:fit-content;width:fit-content;background:linear-gradient(to top right , #8A2BE2 , #00FFFF);max-width:70%;border-radius:15px;border-top-left-radius:unset;text-shadow:0 0 0px #000;border:2px solid #000;border-top-width:1px;border-left-width:1px;"
                },
                [
                    ...message()
                ]
    ...
    return __c(
        ...
        [
            __c(
                "div",
                {
                    style:"padding:15px 10px;min-height:fit-content;width:fit-content;background:#0066FF;max-width:70%;border-radius:15px;border-top-right-radius:unset;text-shadow:0 0 0px #000;border:2px solid #000;border-top-width:1px;border-right-width:1px;"
                },
                [
                    ...message()
                ]
            ...
            __c(
                "i",
                {
                    style:"height:20px;width:20px;font-size:20px;min-width:20px;color:#F4D03F;",
