    ...
    return __c(
        ...
        [
            __c(
                "div",
                {
                    style:"height:70px;width:100px;background-image:url(../assets/logo.png);cursor:pointer;background-image:url('./assets/baseMindLogo.png');"
                },[],
                {
                    genericStyle:["bg_fit"]
                }
            ),
            __SYD.pTag({text:"BaseMind AI" , style:"font-size:17px;font-weight:900;color:#fff;"}),
        ],
        {
            genericStyle:['bg_fit'],
            events:{
